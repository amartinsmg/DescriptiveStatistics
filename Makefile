...
compile: lib dir
	...
	-sEXPORTED_FUNCTIONS=_sort,_mean,_geometricMean,_harmonicMean,_median,_mode,_min,_max,_range,_midrange,_variance,_standardDeviation,_sampleVariance,_sampleStandardDeviation \
